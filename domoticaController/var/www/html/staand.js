...
// php /var/www/html/cli.php cmd=wget params=-qO-\ http://192.168.129.41/cm?cmnd=Power3
//  for(let i = 4; i < 256; i++) {
...
console.log(output);
    ...
    xhr.send("cmd=wget&params="+stringToHex("-qO- http://192.168.129.41/cm?cmnd=Power3"));
//  }
}
//tasmotaLedFadeInOut();
var available = {};
